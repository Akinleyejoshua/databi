...
export default function Header() {
  const { project, isDirty, isSaving, saveProject } = useProjectStore();
  const { activeTab, setActiveTab, setPreviewMode, isPreviewMode, setShareModalOpen } = useUiStore();
      ...
      <div className={styles["header-left"]}>
        ...
        {project && (
          <div className={styles["project-name"]}>
            ...
            {isDirty && <span className={styles["unsaved-dot"]} title="Unsaved changes" />}
          </div>
        )}
      </div>
