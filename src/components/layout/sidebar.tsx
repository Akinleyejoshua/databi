...
export default function Sidebar() {
  const { activeTab, sidebarPanel, setSidebarPanel, dataPanel, setDataPanel, setUploadModalOpen, setRelationshipModalOpen, setMeasureModalOpen, selectedTableId, setSelectedTableId, setEditingMeasureId, addToast, mobileNavOpen, setMobileNavOpen } = useUiStore();
        ...
        <div className={styles["sidebar-header"]}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
            <button className="btn btn-primary btn-sm" onClick={() => setUploadModalOpen(true)}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 0 0 1-2-2v-4"/><polyline points="17 8 12 3 7 8"/><line x1="12" y1="3" x2="12" y2="15"/></svg>
              Upload
            </button>
            <button
